---
title: "Omega Group plc: a case for pay discrimination?"
date: "`r Sys.Date()`"
description: 'Do statistics conclude men earn unfairly more or just lies?'
draft: no
image: pay_gap.jpeg
keywords: ''
slug: pay_discrimination
categories:
- ''
- ''
---
...
Let us carry out the analysis. The objective is to find out whether there is indeed a significant difference between the salaries of men and women, and whether the difference is due to discrimination or whether it is based on another, possibly valid, determining factor. 
...
Let's calculate summary statistics on salary by gender. Also, we shall create and print a dataframe where, for each gender, the mean, SD, sample size, the t-critical, the SE, the margin of error, and the low/high endpoints of a 95% confidence interval are shown.
...
Based on this evidence, can we conclude that there is a significant difference between the experience of the male and female executives? Let's perform similar analyses as in the previous section.
...
Analysing the relationship between salary and experience and drawing a scatterplot to visually inspect the data:
...
> Let's look at the salary vs experience scatterplot. What can we infer from this plot?

> Employees with greater work experience on average receive higher salary, for both males and females. However, this coorelation is notably stronger for female executives, potentially suggesting a less experience-wise merit-based renumeration for men.
